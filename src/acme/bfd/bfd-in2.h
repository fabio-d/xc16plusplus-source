...
#if PIC30
  /* control the user_set_vma flag separately */
#define bfd_set_section_vma(bfd, ptr, val) (((ptr)->vma = (ptr)->lma= (val)), TRUE)
#define bfd_set_user_set_vma(bfd, ptr, val) (((ptr)->user_set_vma = (bfd_boolean)(val)), TRUE)
#else
