#as: --no-warn
#name: -alm Listing file test
#source: cert0026aw.s

# 

.*  .*/gas/pic30/cert0026aw\.s 			page 1
cert0026aw listing test
subtitle1 test
   1              		\.title cert0026aw listing test
...
subtitle2 test
  ...
  38              	\>\>\> \.if 5-\(\(1\+1\)\+1\)
  38              	\>\>\> sum "\(\(\(1\+1\)\+1\)\+1\)",5
  38            04 00 	\>\>\>\> \.long \(\(\(1\+1\)\+1\)\+1\)
  38 0000ea  00 00 00 
  38         00 
  38              	\>\>\>\> \.if 5-\(\(\(1\+1\)\+1\)\+1\)
  38              	\>\>\>\> sum "\(\(\(\(1\+1\)\+1\)\+1\)\+1\)",5
  38            05 00 	\>\>\>\>\> \.long \(\(\(\(1\+1\)\+1\)\+1\)\+1\)
.*  .*/gas/pic30/cert0026aw\.s 			page 6
cert0026aw listing test
subtitle2 test
  38 0000ee  00 00 00 
  38         00 
  38              	\>\>\>\>\> \.if 5-\(\(\(\(1\+1\)\+1\)\+1\)\+1\)
  38              	\>\>\>\>\> sum "\(\(\(\(\(1\+1\)\+1\)\+1\)\+1\)\+1\)",5
  38              	\>\>\>\>\> \.endif
  38              	\>\>\>\> \.endif
  38              	\>\>\> \.endif
  38              	\>\> \.endif
...
subtitle2 test
  ...
  49              		
  50              		\.eject
.*  .*/gas/pic30/cert0026aw\.s 			page 10
cert0026aw listing test
