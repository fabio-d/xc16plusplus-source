#as: --no-warn
#name: -acls Listing file test
#source: cert0026bt.s

# 
MPLAB ASM30 Listing:  .+cert0026bt\.s 			page 1
cert0026bt listing test
subtitle1 test
   1              		\.title cert0026bt listing test
  ...
  16         00 00 00 
MPLAB ASM30 Listing:  .+cert0026bt\.s 			page 2
cert0026bt listing test
subtitle1 test
  ...
  20              		\.eject
MPLAB ASM30 Listing:  .+cert0026bt\.s 			page 3
cert0026bt listing test
subtitle1 test
  21              	
  ...
  32              		\.if 0
  34              		\.endif
MPLAB ASM30 Listing:  .+cert0026bt\.s 			page 4
cert0026bt listing test
subtitle1 test
...
MPLAB ASM30 Listing:  .+cert0026bt\.s 			page 5
cert0026bt listing test
subtitle2 test
  44            00 00 		\.align 2
  45              		
  ...
  50         00 00 00 
  50         02 00 00 
MPLAB ASM30 Listing:  .+cert0026bt\.s 			page 6
cert0026bt listing test
subtitle3 test main routine
  ...
  57              		
  58              		\.eject
MPLAB ASM30 Listing:  .+cert0026bt\.s 			page 7
cert0026bt listing test
subtitle3 test main routine
  ...
  71              		
  72              		
MPLAB ASM30 Listing:  .+cert0026bt\.s 			page 8
cert0026bt listing test
subtitle3 test main routine
DEFINED SYMBOLS
                            \*ABS\*:00000000 fake
                            \*ABS\*:00000001 __C30COFF
.+cert0026bt\.s:61     \.text:0000010a main
.+cert0026bt\.s:19     \.text:00000006 foo
