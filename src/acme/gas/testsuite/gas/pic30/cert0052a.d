#as:
#name: .comm Declare common symbol (min/max)
#source: cert0052a.s

MPLAB ASM30 Listing:  .+cert0052a\.s 			page 1
cert0052a Common symbol\(min/max\)
subtitle1 test
   1              	
   2              		\.title cert0052a Common symbol \(min/max\)
   3              		\.sbttl subtitle1 test
   4              	
   5              		
   6              		\.data
   7                 	
   8                 		\.comm	comsymMax, 0x7fffffff
   9                 		\.comm	comsymMin, 1
  10                 		\.comm	comsym1, 1
  11                 	
  12                 		\.text
...
MPLAB ASM30 Listing:  .+cert0052a\.s 			page 2
cert0052a Common symbol\(min/max\)
subtitle1 test
  16         00 00 00 
  ...
  24         00 00 00 
MPLAB ASM30 Listing:  .+cert0052a\.s 			page 3
cert0052a Common symbol\(min/max\)
subtitle1 test
  ...
  30              		\.eject
MPLAB ASM30 Listing:  .+cert0052a\.s 			page 4
cert0052a Common symbol\(min/max\)
subtitle2 test
  ...
  37         73 75 00 
  37         6D 65 00 
MPLAB ASM30 Listing:  .+cert0052a\.s 			page 5
cert0052a Common symbol\(min/max\)
subtitle3 test main routine
  ...
  38              		
  39              		\.eject
MPLAB ASM30 Listing:  .+cert0052a\.s 			page 6
cert0052a Common symbol\(min/max\)
subtitle3 test main routine
...
MPLAB ASM30 Listing:  .+cert0052a\.s 			page 7
cert0052a Common symbol\(min/max\)
subtitle3 test main routine
  ...
  72         00 00 00 
MPLAB ASM30 Listing:  .+cert0052a\.s 			page 8
cert0052a Common symbol\(min/max\)
subtitle3 test main routine
  73              	
  74              	
  75              		
MPLAB ASM30 Listing:  .+cert0052a.s 			page 9
cert0052a Common symbol\(min/max\)
subtitle3 test main routine
DEFINED SYMBOLS
                            \*ABS\*:00000000 fake
                            \*ABS\*:00000001 __C30COFF
                            \*COM\*:7fffffff comsymMax
                            \*COM\*:00000001 comsymMin
                            \*COM\*:00000001 comsym1
.+cert0052a.s:42     \.text:000000d4 main
.+cert0052a.s:45     \.text:000000d8 L11
.+cert0052a.s:48     \.text:000000de L21
.+cert0052a.s:52     \.text:000000e6 L31
.+cert0052a.s:54     \.text:000000ea L41
.+cert0052a.s:56     \.text:000000ee L51
.+cert0052a.s:59     \.text:000000f4 L61
.+cert0052a.s:62     \.text:000000fa L71
.+cert0052a.s:66     \.text:00000102 L81
.+cert0052a.s:69     \.text:00000108 L91
.+cert0052a.s:72     \.text:0000010c L1
MPLAB ASM30 Listing:  .+cert0052a.s 			page 10
cert0052a Common symbol\(min/max\)
subtitle3 test main routine
.+cert0052a.s:29     \.text:00000032 foo
