#as: --no-warn
#name: -acdhlms Listing file test
#source: cert0026ev.s

# 
MPLAB ASM30 Listing:  .+cert0026ev\.s 			page 1
cert0026ev listing test
subtitle1 test
   1              		\.title cert0026ev listing test
  ...
  16         00 00 00 
MPLAB ASM30 Listing:  .+cert0026ev\.s 			page 2
cert0026ev listing test
subtitle1 test
  ...
  20              		\.eject
MPLAB ASM30 Listing:  .+cert0026ev\.s 			page 3
cert0026ev listing test
subtitle1 test
  21              	
  ...
  32              		\.if 0
  34              		\.endif
MPLAB ASM30 Listing:  .+cert0026ev\.s 			page 4
cert0026ev listing test
subtitle1 test
...
MPLAB ASM30 Listing:  .+cert0026ev\.s 			page 5
cert0026ev listing test
subtitle2 test
  44            00 00 		\.align 2
  45              		
  ...
  46         00 00 00 
MPLAB ASM30 Listing:  .+cert0026ev\.s 			page 6
cert0026ev listing test
subtitle2 test
  46              	\>\>\>\> \.if 5-\(\(\(1\+1\)\+1\)\+1\)
  46              	\>\>\>\> sum \"\(\(\(\(1\+1\)\+1\)\+1\)\+1\)\",5
  ...
  50         00 00 00 
  50              	\> \.if 2-1
MPLAB ASM30 Listing:  .+cert0026ev\.s 			page 7
cert0026ev listing test
subtitle2 test
  50              	\> sum \"\(1\+1\)\",2
  ...
  54         00 00 00 
  54              	\>\> \.if 4-\(1\+1\)
MPLAB ASM30 Listing:  .+cert0026ev\.s 			page 8
cert0026ev listing test
subtitle2 test
  54              	\>\> sum \"\(\(1\+1\)\+1\)\",4
  ...
  57              		
  58              		\.eject
MPLAB ASM30 Listing:  .+cert0026ev\.s 			page 9
cert0026ev listing test
subtitle3 test main routine
  ...
  71              		
  72              		
MPLAB ASM30 Listing:  .+cert0026ev\.s 			page 10
cert0026ev listing test
subtitle3 test main routine
DEFINED SYMBOLS
                            \*ABS\*:00000000 fake
                            \*ABS\*:00000001 __C30COFF
.+cert0026ev\.s:61     \.text:0000010a main
.+cert0026ev\.s:19     \.text:00000006 foo
