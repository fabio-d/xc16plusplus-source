...
Pass:   goto    Pass_end
        ...
        HALT             
           ...
           .section foo0, code
           .ascii   "Begin first pfill in foo0"
           .pfill 0, 1, 1
           .pfill 1, 0, 1
           .pfill 1, 1, 0

           .ascii   "Begin second pfill in foo0 with all zeros"  
           .pfill 0, 0, 0

           .ascii "Begin third pfill"
           .pfill    0x0F, 4, 0x12345678

           .ascii "Begin fourth pfill"
           .pfill    0xFF, 8, 0xFFFFFFFF     
   
           
           .section .const
           .ascii "Begin first pfill .const"
           .pfill 1
           .ascii "Begin second pfill .const "
           .pfill 100

           .ascii "Begin third pfill .const"
           .pfill    0x0F, 4, 0x12345678

           .ascii "Begin fourth pfill .const"
           .pfill    0x0F, 8, 0xA5B4C3D2  

           .ascii "Begin fifth pfill .const"
           .pfill    0x0F, 8, 0xA5B4C3D2
   
           .ascii   "End of .const section"
           .nolist
