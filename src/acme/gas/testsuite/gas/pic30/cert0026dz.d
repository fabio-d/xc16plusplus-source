#as: --no-warn
#name: -adhls Listing file test
#source: cert0026dz.s

#
MPLAB ASM30 Listing:  .+cert0026dz\.s 			page 1
cert0026dz listing test
subtitle1 test
   1              		\.title cert0026dz listing test
  ...
  16         00 00 00 
MPLAB ASM30 Listing:  .+cert0026dz\.s 			page 2
cert0026dz listing test
subtitle1 test
  ...
  20              		\.eject
MPLAB ASM30 Listing:  .+cert0026dz\.s 			page 3
cert0026dz listing test
subtitle1 test
  21              	
...
MPLAB ASM30 Listing:  .+cert0026dz\.s 			page 4
cert0026dz listing test
subtitle1 test
  34              		\.endif
  ...
  42              		
MPLAB ASM30 Listing:  .+cert0026dz\.s 			page 5
cert0026dz listing test
subtitle2 test
  ...
  50         00 00 00 
MPLAB ASM30 Listing:  .+cert0026dz\.s 			page 6
cert0026dz listing test
subtitle3 test main routine
  ...
  57              		
  58              		\.eject
MPLAB ASM30 Listing:  .+cert0026dz\.s 			page 7
cert0026dz listing test
subtitle3 test main routine
MPLAB ASM30 Listing:  .+cert0026dz\.s 			page 8
cert0026dz listing test
subtitle3 test main routine
  ...
  71              		
  72              		
MPLAB ASM30 Listing:  .+cert0026dz\.s 			page 9
cert0026dz listing test
subtitle3 test main routine
DEFINED SYMBOLS
                            \*ABS\*:00000000 fake
                            \*ABS\*:00000001 __C30COFF
.+cert0026dz\.s:61     \.text:0000010a main
.+cert0026dz\.s:19     \.text:00000006 foo
