#as: --no-warn
#name: -alms Listing file test
#source: cert0026da.s

#  
MPLAB ASM30 Listing:  .+cert0026da\.s 			page 1
cert0026da listing test
subtitle1 test
   1              		\.title cert0026da listing test
  ...
  16         00 00 00 
MPLAB ASM30 Listing:  .+cert0026da\.s 			page 2
cert0026da listing test
subtitle1 test
  ...
  20              		\.eject
MPLAB ASM30 Listing:  .+cert0026da\.s 			page 3
cert0026da listing test
subtitle1 test
  21              	
...
MPLAB ASM30 Listing:  .+cert0026da\.s 			page 4
cert0026da listing test
subtitle1 test
  34              		\.endif
  ...
  42              		
MPLAB ASM30 Listing:  .+cert0026da\.s 			page 5
cert0026da listing test
subtitle2 test
...
MPLAB ASM30 Listing:  .+cert0026da\.s 			page 6
cert0026da listing test
subtitle2 test
  46         00 00 00 
  46              	\>\>\>\> \.if 5-\(\(\(1\+1\)\+1\)\+1\)
...
MPLAB ASM30 Listing:  .+cert0026da\.s 			page 7
cert0026da listing test
subtitle2 test
  50         00 00 00 
  50              	\> \.if 2-1
  ...
  54              	\> \.if 4-1
  54              	\> sum \"\(1\+1\)\",4
MPLAB ASM30 Listing:  .+cert0026da\.s 			page 8
cert0026da listing test
subtitle2 test
  ...
  54              	\> \.endif
  55              		
MPLAB ASM30 Listing:  .+cert0026da\.s 			page 9
cert0026da listing test
subtitle2 test
  56              	/\* End of macro expansions \*/	
  57              		
  58              		\.eject
MPLAB ASM30 Listing:  .+cert0026da\.s 			page 10
cert0026da listing test
subtitle3 test main routine
  ...
  71              		
  72              		
MPLAB ASM30 Listing:  .+cert0026da\.s 			page 11
cert0026da listing test
subtitle3 test main routine
DEFINED SYMBOLS
                            \*ABS\*:00000000 fake
                            \*ABS\*:00000001 __C30COFF
.+cert0026da\.s:61     \.text:0000010a main
.+cert0026da\.s:19     \.text:00000006 foo
