...
; The readonly section under test begins here.
...
constalgn2:   .byte 1
          ...
          .data
failstr:  .asciz "faila: itr %d\n"
passstr:  .asciz "passa: itr %d\n"
passall:  .asciz "PASSa: itr END\n"
failall:  .asciz "FAILa: itr END\n"
          .text
state_preserve:
        mov   SR, w0
        xor   Save_stat,wreg
